...
| Module | Capabilities |
|---|---|
| **Security Operations Dashboard** | KPI cards, pie/column charts, trend filters; operational records where a **Guard name is picked from the 201 File** (`Full Name — Employee No`), not typed |
