...
router.get("/:id/report.pdf", requireAuth, async (req, res) => {
  ...
  doc.fillColor("#fff").fontSize(18).text("Training & Certification Record", textX, 44);
  ...
  doc.fillColor(MUTE).fontSize(8).text(
    `This report was generated by the ${companyName} CSOMS Training & Certification Management module.`,
    { align: "center" }
  );
