...
router.get("/:id/report.pdf", requireAuth, async (req, res) => {
  ...
  doc.fillColor("#fff").fontSize(18).text("Daily Security Report", textX, 44);
  doc.fillColor("#C9D3E3").fontSize(10).text(`${r.code}  \u00b7  Generated ${new Date().toLocaleDateString()}`, textX, 68);
  doc.y = 110;
  ...
  doc.fillColor(MUTE).fontSize(8).text(
    `This report was generated by the ${companyName} CSOMS Daily Security Report module.`,
    { align: "center" }
  );
