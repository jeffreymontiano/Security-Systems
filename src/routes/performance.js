...
router.get("/:id/report.pdf", requireAuth, async (req, res) => {
  ...
  doc.fillColor("#fff").fontSize(18).text("Performance Appraisal Report", textX, 44);
  ...
  doc.fillColor(MUTE).fontSize(8).text(
    `This report was generated by the ${companyName} CSOMS Performance Appraisal module. Confidential HR record.`,
    { align: "center" }
  );
