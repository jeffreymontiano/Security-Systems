...
router.get("/:id/report.pdf", requireAuth, async (req, res) => {
  ...
  doc.fillColor("#fff").fontSize(18).text("Disciplinary Action Case Report", 50, 44);
  ...
  doc.fillColor(MUTE).fontSize(8).text(
    "This report was generated by the Brookside Farms CSOMS Disciplinary Action & Infraction Management module. Confidential HR record.",
    { align: "center" }
  );
